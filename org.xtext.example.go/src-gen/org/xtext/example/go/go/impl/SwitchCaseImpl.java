 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.go.go.impl.SwitchCaseImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchCaseImpl extends MinimalEObjectImpl.Container implements SwitchCase
{
  ...
  public EList<Statement> getStatement()
  {
    if (statement == null)
    {
      statement = new EObjectContainmentEList<Statement>(Statement.class, this, GoPackage.SWITCH_CASE__STATEMENT);
    }
    return statement;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GoPackage.SWITCH_CASE__STATEMENT:
