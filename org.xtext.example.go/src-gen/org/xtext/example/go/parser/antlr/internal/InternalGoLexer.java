...
public class InternalGoLexer extends Lexer {
    ...
    public final void mT__39() throws RecognitionException {
        try {
            int _type = T__39;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:33:7: ( 'var' )
            // InternalGo.g:33:9: 'var'
            {
            match("var"); 
    ...
    public final void mRULE_TYPE() throws RecognitionException {
        try {
            int _type = RULE_TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2327:11: ( ( 'string' | 'int' | 'bool' ) )
            // InternalGo.g:2327:13: ( 'string' | 'int' | 'bool' )
            {
            // InternalGo.g:2327:13: ( 'string' | 'int' | 'bool' )
            int alt1=3;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_OP_SUM() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2329:13: ( ( '+' | '-' ) )
            // InternalGo.g:2329:15: ( '+' | '-' )
            {
    ...
    public final void mRULE_OP_MULT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2331:14: ( ( '*' | '/' ) )
            // InternalGo.g:2331:16: ( '*' | '/' )
            {
            if ( input.LA(1)=='*'||input.LA(1)=='/' ) {
                input.consume();
    ...
    public final void mRULE_OP_REL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2333:13: ( ( '<=' | '>=' | '<' | '>' ) )
            // InternalGo.g:2333:15: ( '<=' | '>=' | '<' | '>' )
            {
            // InternalGo.g:2333:15: ( '<=' | '>=' | '<' | '>' )
            int alt2=4;
    ...
    public final void mRULE_OP_UNARY() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2335:15: ( ( '==' | '!=' ) )
            // InternalGo.g:2335:17: ( '==' | '!=' )
            {
            // InternalGo.g:2335:17: ( '==' | '!=' )
            int alt3=2;
    ...
    public final void mRULE_BOOL() throws RecognitionException {
        try {
            int _type = RULE_BOOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2337:11: ( ( 'true' | 'false' ) )
            // InternalGo.g:2337:13: ( 'true' | 'false' )
            {
            // InternalGo.g:2337:13: ( 'true' | 'false' )
            int alt4=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2339:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalGo.g:2339:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalGo.g:2339:11: ( '^' )?
            int alt5=2;
            ...
            // InternalGo.g:2339:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2341:10: ( ( '0' .. '9' )+ )
            // InternalGo.g:2341:12: ( '0' .. '9' )+
            {
            // InternalGo.g:2341:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2343:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGo.g:2343:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGo.g:2343:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalGo.g:2343:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGo.g:2343:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalGo.g:2343:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGo.g:2343:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2345:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGo.g:2345:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGo.g:2345:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2347:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGo.g:2347:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGo.g:2347:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2349:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGo.g:2349:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGo.g:2349:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGo.g:2351:16: ( . )
            // InternalGo.g:2351:18: .
            {
            matchAny(); 
    ...
    static final String DFA16_eotS =
        "\2\uffff\1\51\2\uffff\1\55\2\51\1\63\1\65\1\51\1\uffff\1\51\1\uffff\2\51\1\uffff\2\51\2\104\2\110\1\114\2\44\1\51\2\uffff\1\51\1\44\2\uffff\2\44\3\uffff\1\51\1\126\1\51\5\uffff\4\51\4\uffff\2\51\1\uffff\2\51\1\uffff\3\51\1\uffff\2\51\15\uffff\1\51\1\uffff\1\51\3\uffff\1\51\1\uffff\1\150\1\51\1\152\12\51\1\165\3\51\1\uffff\1\51\1\uffff\1\172\5\51\1\u0080\2\51\1\u0083\1\uffff\1\150\1\u0084\2\51\1\uffff\1\u0084\1\u0087\3\51\1\uffff\1\u008b\1\51\2\uffff\1\u008d\1\51\1\uffff\1\u008f\1\u0090\1\150\1\uffff\1\51\1\uffff\1\u0092\2\uffff\1\u0093\2\uffff";
    static final String DFA16_eofS =
        "\u0094\uffff";
    static final String DFA16_minS =
